...
const questions = 
[
  new Question("Какие роли играют DNS серверы и Active Directory в сети?", 
  [
    new Answer("Управление печатью", 0),
    new Answer("Аутентификация пользователей и предоставление доступа к ресурсам", 1),
    new Answer("Установка обновлений", 0),
    new Answer("Все вышеперечисленное", 0)
  ]),
