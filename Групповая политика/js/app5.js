...
const questions = 
[
  new Question("Что представляет собой локальная групповая политика?", 
  [
    new Answer("Управление настройками для всей сети", 0),
    new Answer("Установка глобальных правил безопасности", 0),
    new Answer("Контроль параметров текущего устройства", 1),
    new Answer("Работа только в домене", 0)
  ]),
