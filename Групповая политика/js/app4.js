...
const questions = 
[
  new Question("Какие четыре ключевые области были выделены разработчиками Windows Server 2019?", 
  [
    new Answer("Игры, мультимедиа, обновления, безопасность", 0),
    new Answer("Интерфейс, производительность, виртуализация, браузер", 0),
    new Answer("Обновления, аутентификация, совместимость, безопасность", 0),
    new Answer("Гибридное облако, безопасность, платформа приложений, гиперконвергентная инфраструктура", 1)
  ]),
