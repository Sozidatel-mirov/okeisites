...
const questions = 
[
  new Question("Выберите правильный вариант для определения целевой эмоции", 
  [
    new Answer("Определить эмоцию, которая хорошо смотрится на камере", 1),
    new Answer("Задать актерам какие эмоции они должны передавать, не обращая внимание на общий настрой ролика", 0),
    new Answer("Использовать случайную эмоцию, чтобы сделать контент более разнообразным", 0),
    new Answer("Выбрать эмоцию, которую хочется вызвать у зрителей", 0)
  ]),
...
function Update()
{
  ...
  nextButton.addEventListener("click", function () {
    ...
    pagesElem.innerHTML = (7) + " / " + quiz.questions.length;
