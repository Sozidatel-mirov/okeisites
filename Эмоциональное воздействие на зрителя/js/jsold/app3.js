...
const questions = 
[
  new Question("Выберите наилучший вариант для создания сценария и режиссуры", 
  [
    new Answer("Найти случайных актеров и позволить им действовать свободно", 0),
    new Answer("Не заморачиваться с сценарием, просто снимать случайные сцены", 0),
    new Answer("Разработать сценарий, подчеркивающий выбранную эмоцию, и режиссировать актеров соответствующим образом", 1),
    new Answer("Позволить актерам играть, как им хочется, без конкретных указаний", 0)
  ])
];
