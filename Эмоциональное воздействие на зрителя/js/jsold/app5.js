...
const questions = 
[
  new Question("Выберите наилучший вариант для звукового оформления", 
  [
    new Answer("Не обращать внимание на звуковое оформление, оставить все на усмотрение звукооператора", 0),
    new Answer("Оставить звуковое оформление на усмотрение монтажера, без конкретных указаний", 0),
    new Answer("Добавить звуковой трек, который соответствует выбранной эмоции, чтобы усилить эмоциональное воздействие", 1),
    new Answer("Позволить актерам говорить как хотят, без добавления музыкальных сопровождений", 0)
  ]),
...
function Update()
{
  ...
  nextButton.addEventListener("click", function () {
    ...
    pagesElem.innerHTML = (10) + " / " + quiz.questions.length;
