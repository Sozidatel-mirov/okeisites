...
// Массив с вопросами
const questions = [
  new Question("Какой тип графического изображения используется для редактирования цифровых фотографий?", 
  [
    new Answer("Растровый", 0),
    new Answer("Векторный", 0),
    new Answer("Схематичный", 1),
