...
// Массив с вопросами
const questions = [
  new Question("Выберите один правильный ответ. Примитивом называются ...", 
  [
    new Answer("Картины, нарисованные ребенком", 0),
    new Answer("Простые карандаши", 0),
    new Answer("Точки на рисунке", 0),
    new Answer("Простые объекты", 1)
  ])
];
