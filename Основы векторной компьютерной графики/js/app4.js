...
const questions = [
  ...
  [
    new Answer("полноцветное изображение, обработанное особым образом и хранящееся в памяти компьютера", 0),
    new Answer("чертежи, выполняемые графическими редакторами для проектных работ", 0),
    new Answer("изображение, создаваемое посредством математических вычислений, представляющее собой набор действий по созданию рисунка с помощью различных линий, фигур", 1),
    new Answer("схема из простых геометрических фигур", 0)
  ])
];
