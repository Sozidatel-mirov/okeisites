...
const questions = 
[
  new Question("Какие элементы следует учесть при разработке креативного сообщения?", 
  [
    new Answer("Только текст", 0),
    new Answer("Только визуальные элементы", 0),
    new Answer("Визуальные и текстовые элементы", 1)
  ]),
