...
const questions = 
[
  new Question("Почему важно понимать свою целевую аудиторию?", 
  [
    new Answer("Для увеличения бюджета", 0),
    new Answer("Для более эффективного воздействия", 1),
    new Answer("Для создания рекламных материалов", 0)
  ]),
