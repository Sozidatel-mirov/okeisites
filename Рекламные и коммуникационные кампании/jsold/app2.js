...
const questions = 
[
  new Question("Какой первый шаг при планировании рекламной кампании?", 
  [
    new Answer("Определить цель", 1),
    new Answer("Разработать креативные материалы", 0),
    new Answer("Выбрать средства рекламы", 0),
    new Answer("Выбрать целевую аудиторию", 0)
  ]),
