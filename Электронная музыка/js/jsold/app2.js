...
const questions = 
[
  new Question("1.	В начале 60 ых появились два значительных произведения от двух влиятельных композиторов электронной музыки. Какие это композиторы?", 
  [
    new Answer("Отто Льюэнинг и Штокхаузен ", 1),
    new Answer("Дэлия Дэрбишир и Рон Грэйнер", 0),
    new Answer("Йозеф Таль и Жан-Мишель Жарр", 0),
    new Answer("Дон Бушла и Ферручио Бузони", 0)
  ]),
