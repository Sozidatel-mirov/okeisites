...
const questions = 
[
  new Question("Что из перечисленного относится к пост-производственному этапу маркетинговой деятельности?", 
  [
    new Answer("Анализ конъюнктуры рынка", 0),
    new Answer("Анализ возможности фирмы", 0),
    new Answer("Приспособление производства к потребностям рынка", 0),
    new Answer("Продвижение товара", 1)
  ]),
