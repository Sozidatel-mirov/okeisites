...
function Update()
{
  ...
  nextButton.addEventListener("click", function () {
    ...
    window.location.href = "quiz8.html?score=" + quiz.score + "&timeMinute=" + timeMinute + "&timeSecond=" + timeSecond; // Замените на фактический URL вашей страницы с результатами
  });
} else {
