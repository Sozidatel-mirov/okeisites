...
const questions = 
[
  new Question("Какая информация относится к первичным данным маркетиговых исследований", 
  [
    new Answer("Предварительная информация, полученная в ходе исследований", 0),
    new Answer("Информация, полученная из СМИ", 0),
    new Answer("Информация, собранная впервые с какой-либо конкретной целью", 1),
    new Answer("Данные, предоставленные фирмой", 0)
  ]),
