...
// Массив с вопросами
const questions = [
  new Question("На каком предприятии эффективнее используются оборотные средства", 
  [
    new Answer("макаронная фабрика", 1),
    new Answer("кондитерская фабрика", 0)
    ])
];
