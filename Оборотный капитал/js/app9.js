...
function Update()
{
  ...
  nextButton.addEventListener("click", function () {
    ...
    window.location.href = "result.html?score=" + score12 + "&timeMinute=" + timeMinute + "&timeSecond=" + timeSecond; // Замените на фактический URL вашей страницы с результатами
  });
} else {
