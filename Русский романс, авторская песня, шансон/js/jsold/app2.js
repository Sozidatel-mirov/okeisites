...
const questions = 
[
  new Question("Самые знаменитые русские композиторы, которые сочиняли в жанре русского романса?", 
  [
    new Answer("Чайковский, Рахманинов, Римский-Корсаков", 1),
    new Answer("Григорий Лепс, Михаил Шуфутинский", 0),
    new Answer("Элла Фицджеральд, Билли Холидей", 0)
  ]),
