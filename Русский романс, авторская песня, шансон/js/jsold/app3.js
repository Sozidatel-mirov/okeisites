...
const questions = 
[
  new Question("Дальнейшее развитие жанра романса в XX веке начинается с расширения новых задач: развитие новых музыкальных форм, новый синтез музыки и поэзии. Возникает новый жанр – «стихотворение с музыкой». Кто из композиторов писал в новом жанре?", 
  [
    new Answer("Гумилёв", 0),
    new Answer("С.И.Танеев", 1),
    new Answer("Варламов", 0),
    new Answer("Кюи", 0)
  ]),
