...
const questions = 
[
  new Question("Что является самой основной отличительной особенностью шансона?", 
  [
    new Answer("Выдуманный сюжет", 0),
    new Answer("Сюжет из книг поэтов", 0),
    new Answer("Сюжет из реальной жизни", 1),
    new Answer("Рассказы и былины народа", 0)
  ]),
